...
% PROV-AI-START
\textbf{Author-written or author-reviewed:} Abstract, Introduction, Group-Fairness Notions, Individual Fairness, Conclusion.
\textbf{AI-drafted (pending review):} Preliminaries \& Notation (\S\ref{sec:prelim}), Proportionality/Core \& Stability (\S\ref{sec:prop}), Algorithmic Techniques (\S\ref{sec:tech}), Future Directions (\S\ref{sec:open}), the taxonomy figure, Table~\ref{tab:results}. AI-drafted sections also carry an inline banner.
% PROV-AI-END
}}
\medskip
...
\bibliography{fair_clustering_ref, fair_ref, fair_clustering_gscholar, survey_ai_additions, survey_new_2026}
\end{document}
