...
\caption{Representative fair-clustering guarantees surveyed in Part~I. Entries $(\alpha,\beta)$ denote bicriteria bounds (cost factor $\alpha$, fairness slack $\beta$); $\ell$ is the number of groups and $\Delta$ the maximum group-membership multiplicity. \emph{AI-drafted table; verify before use.}}\label{tab:results}
