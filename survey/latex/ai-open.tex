...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item \textbf{Richer objectives.} Fair variants of sum-of-radii and min-sum-radii, correlation and non-centroid clustering, and cluster editing are only beginning to be understood~\citep{fairsumradii2025,fptminsumradii2024,unifyingprop2026,modfairclusterediting2021}.
